...
namespace GameProject
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            burger = new Burger(Content, "burger",graphics.PreferredBackBufferWidth / 2,
			...
			foreach (TeddyBear bear in bears)
			{
				...
				foreach (Projectile projectile in projectiles)
				{
					...
					if (projectile.CollisionRectangle.Intersects (bear.CollisionRectangle)
						&& projectile.Type ==ProjectileType.FrenchFries && bear.Active == true && projectile.Active == true) 
					{
							bear.Active = false;
